        ...
        <div class="row">
            <div class="col-md-8">
                @if(Session('info')) <div class="alert alert-success">{{Session('info')}}</div> @endif
                    <div class="card" style="background: #f2dede">
                        <div class="card-header" style="background: #f2a29f"><i class="fas fa-list-alt"></i> Categories</div>
            ...
            <div class="col-md-4">
                @if(Session('alert')) <div class="alert alert-success">{{Session('alert')}}</div> @endif
                    <div class="card" style="background: #f2dede">
                        <div class="card-header" style="background: #f2a29f"><i class="fas fa-plus"></i> New Category</div>
                    <div class="card-body">
